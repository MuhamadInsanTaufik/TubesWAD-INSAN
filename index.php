...
<body>
  ...
  <main>
    <div class="container">
    <div class="row">
        <img src="assets/Photo/suklib.png" class="mx-auto" alt="" style="width: 180px; height: auto; padding-bottom: 20px; padding-top: 60px;">
        <h3 style="text-align: center; color: #012970; padding-bottom : 20px">Selamat Datang di Sukapura Library!</h3>
    </div>
      ...
      <div class="col-lg-3">
          <div class="card">
            <div class="card-body text-center">
              ...
              <a class="nav-link collapsed" href="pages-login-member.php">
      ...
      <div class="col-lg-3">
          <div class="card">
            <div class="card-body text-center">
              ...
              <a class="nav-link collapsed" href="pages-login-admin.php">
