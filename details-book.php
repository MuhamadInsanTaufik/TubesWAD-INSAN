...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item" style="padding-top: 10px">
        <a class="nav-link " href="home-member.php">
  ...
  <main id="main" class="main">
    ...
    <section class="section">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p style="font-size: 14px;">Hidayatul Fajriyah atau lebih dikenal dengan nama Luluk HF adalah seorang penulis 
                berasal dari Lamongan Jawa Timur. Ia merupakan salah satu penulis yang aktif mengunggah 
                karya tulisnya di wattpad. Beberapa novel karyanya pernah diadaptasi menjadi film seperti EL, 
      ...
      <div class="row">
        <h5><b>Sinopsis</b></h5>
        <p style="text-align: justify;">Novel Mariposa mengisahkan seorang gadis cantik bernama Natasha Kay Loovi atau kerap disapa Acha yang 
          memperjuangkan cintanya terhadap seorang laki-laki berhati beku dan super dingin–bagaikan es–dengan 
          kehidupannya yang serba monoton, bernama Iqbal. Mereka berdua adalah siswa yang sangat pintar di sekolah.</p>
      </div>
    </section>
